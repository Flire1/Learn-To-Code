...
print("My favorite food is", favorite_food)  # Output: My favorite food is Pizza
...
print("My hobby is", hobby)  # Output: My hobby is Coding
# Explanation: This is another example of using variables with text.

# Challenge Exercise
# Create your own variable and print its value. For example:
favorite_color = "Blue"
print("My favorite color is", favorite_color)  # Output: My favorite color is Blue
